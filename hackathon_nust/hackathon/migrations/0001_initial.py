# Generated by Django 3.2.8 on 2021-10-16 15:35
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('load', models.CharField(choices=[('h', 'high'), ('l', 'low'), ('m', 'medium')], max_length=1)),
        ...
        migrations.CreateModel(
            name='Research_supervision',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('student_name', models.CharField(max_length=50)),
                ('research_type', models.CharField(choices=[('h', 'honours'), ('p', 'postgraduate')], max_length=1)),
                ('user', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
